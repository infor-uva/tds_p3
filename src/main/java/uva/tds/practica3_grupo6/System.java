 ...
 * {@link SistemaPersistenciaSinAislamiento#addRecorrido(Recorrido)}</li>
 * <li>Remove a Recorrido of system<br>
 * {@link SistemaPersistenciaSinAislamiento#removeRecorrido(String)}</li>
 * <li>Consult the list of recorridos in system<br>
 * {@link SistemaPersistenciaSinAislamiento#getRecorridos()}</li> Consult the total price
 * accumulated by a user<br>
 * {@link SistemaPersistenciaSinAislamiento#getPrecioTotalBilletesUsuario(String)}</li>
 * <li>Consult the list of Recorridos that have a specific date<br>
 * {@link SistemaPersistenciaSinAislamiento#getRecorridosDisponiblesFecha(LocalDate)}</li>
 * <li>Consult the list of Billetes which are associated to the recorrido
 * route<br>
 * {@link SistemaPersistenciaSinAislamiento#getAssociatedBilletesToRoute(String)}</li>
 * <li>Consult the date of the route which have the id specified<br>
 * {@link SistemaPersistenciaSinAislamiento#getDateOfRecorrido(String)}</li>
 * <li>Consult the time of the route which have the id specified<br>
 * {@link SistemaPersistenciaSinAislamiento#getTimeOfRecorrido(String)}</li>
 * <li>Consult the date and time of the route which have the id specified<br>
 * {@link SistemaPersistenciaSinAislamiento#getDateTimeOfRecorrido(String)}</li>
 * <li>Update the date of a recorrido<br>
 * {@link SistemaPersistenciaSinAislamiento#updateRecorridoDate(String, LocalDate)}</li>
 * <li>Update the time of a recorrido<br>
 * {@link SistemaPersistenciaSinAislamiento#updateRecorridoTime(String, LocalTime)}</li>
 * <li>Update the time and date of a recorrido<br>
 * {@link SistemaPersistenciaSinAislamiento#updateRecorrido(String, LocalDate, LocalTime)}</li>
 * <li>Reserve tickets for a Recorrido and a Usuario<br>
 * {@link SistemaPersistenciaSinAislamiento#reservarBilletes(String, Usuario, Recorrido, int)}</li>
 * <li>Cancel a reservation<br>
 * {@link SistemaPersistenciaSinAislamiento#anularReserva(String, int)}</li>
 * <li>Return the tickets<br>
 * {@link SistemaPersistenciaSinAislamiento#devolverBilletes(String, int)}</li>
 * <li>Buy tickets for a Recorrido and a Usuario<br>
 * {@link SistemaPersistenciaSinAislamiento#comprarBilletes(String, Usuario, Recorrido, int)}</li>
 * <li>Buy reserved tickets (the previously reserved lot)<br>
 * {@link SistemaPersistenciaSinAislamiento#comprarBilletesReservados(String)}</li>
 * </ul>
 * 
 * @author hugcubi
 * @author diebomb
